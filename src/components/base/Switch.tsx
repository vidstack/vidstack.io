	...
	return (
		...
		>
			...
			<span
				aria-hidden="true"
				className={clsx(
					'pointer-events-none inline-block w-5 h-5 rounded-full -mt-0.5',
			...
			>
				<CheckmarkIcon
					className={clsx(
						'w-3 h-3 opacity-0 transition-opacity ease-in-out duration-200 text-gray-100 dark:text-gray-400',
						isOn && 'opacity-100',
					)}
				/>
			</span>
