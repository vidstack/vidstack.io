...
function CodeSnippet({
	...
	return (
		<div className="bg-[#292D3E] relative flex flex-col w-full max-w-2xl h-[31.625rem] max-h-[60vh] 576:max-h-[none] rounded-lg 992:h-[34.6875rem] 1200:h-[31.625rem] overflow-hidden shadow-xl">
